...
import com.alibaba.nacos.plugin.auth.impl.persistence.handler.support.OralcePageHandlerAdapter;
...
public class PageHandlerAdapterFactory {
    ...
    private void initHandlerAdapters() {
        ...
        // Oralce OR DM PageHandlerAdapter
        addHandlerAdapter(new OralcePageHandlerAdapter());
