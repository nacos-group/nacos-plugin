...
/**
 * The base implementation of AiResourceVersionMapper.
 *
 * @author Ken
 */
public class OpenGaussAiResourceVersionMapper extends AbstractMapperByGaussdb implements AiResourceVersionMapper {
