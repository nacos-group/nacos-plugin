 ...
 * @author jowee
 */
public enum TrustedXuguFunctionEnum {
    ...
    private static final Map<String, TrustedXuguFunctionEnum> LOOKUP_MAP = new HashMap<>();

    static {
        for (TrustedXuguFunctionEnum entry : TrustedXuguFunctionEnum.values()) {
    ...
    TrustedXuguFunctionEnum(String functionName, String function) {
    ...
    public static String getFunctionByName(String functionName) {
        TrustedXuguFunctionEnum entry = LOOKUP_MAP.get(functionName);
        if (entry != null) {
