...
public class ConfigInfoMapperByKingbase extends AbstractMapperByKingbase implements ConfigInfoMapper {
    ...
    public MapperResult findConfigInfoByAppFetchRows(MapperContext context) {
        ...
        String sql = "SELECT id,data_id,group_id,tenant_id,app_name,content FROM config_info"
                + " WHERE tenant_id LIKE ? AND app_name= ?" + " LIMIT " + context.getPageSize()
    ...
    public MapperResult findConfigInfoBaseLikeFetchRows(MapperContext context) {
        ...
        return new MapperResult(sqlFetchRows + where + " LIMIT " + context.getPageSize() + " OFFSET " + context.getStartRow(), paramList);
    }
    ...
    public MapperResult findConfigInfo4PageFetchRows(MapperContext context) {
        ...
        // 先分页，减少后续 JOIN 的数据量
        innerSql.append(" LIMIT ").append(context.getPageSize()).append(" OFFSET ").append(context.getStartRow());
