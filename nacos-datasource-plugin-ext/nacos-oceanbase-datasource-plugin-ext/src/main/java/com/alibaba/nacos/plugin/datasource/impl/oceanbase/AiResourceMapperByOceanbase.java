 ...
 * @author Ken
 */
public class AiResourceMapperByOceanbase extends AbstractOceanbaseMapper implements AiResourceMapper {
    ...
    public MapperResult findAiResourceFetchRows(MapperContext context) {
        ...
        String sql = getLimitPageSqlWithMark(built.getSql() + resolveOrderByClause(context));
