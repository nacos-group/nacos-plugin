 ...
 * @author Ken
 */
public class AiResourceVersionByOceanbase extends AbstractOceanbaseMapper implements AiResourceVersionMapper {
    ...
    public MapperResult findAiResourceVersionFetchRows(MapperContext context) {
        ...
        String sql = getLimitPageSqlWithMark(built.getSql() + " ORDER BY gmt_modified DESC ");
