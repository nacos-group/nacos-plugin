...
/**
 * The OceanBase implementation of ConfigTagsRelationMapper in Oracle mode.
 *
 * @author OceanBase Plugin Team
 **/
public class ConfigTagsRelationMapperByOceanbase extends AbstractOceanbaseMapper
