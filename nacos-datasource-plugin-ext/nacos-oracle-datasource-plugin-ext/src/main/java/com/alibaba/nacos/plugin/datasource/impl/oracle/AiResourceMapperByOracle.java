 ...
 * @author Ken
 */
public class AiResourceMapperByOracle extends AbstractOracleMapper implements AiResourceMapper {
    ...
    public MapperResult findAiResourceFetchRows(MapperContext context) {
        ...
        String sql = getDatabaseDialect().getLimitPageSqlWithOffset(built.getSql() + resolveOrderByClause(context),
