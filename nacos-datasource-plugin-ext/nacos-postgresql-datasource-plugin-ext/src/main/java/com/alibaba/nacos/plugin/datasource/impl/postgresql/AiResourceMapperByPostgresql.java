...
/**
 * The postgresql implementation of AiResourceMapper
 *
 * @author Ken
 */
public class AiResourceMapperByPostgresql extends AbstractMapperByPostgresql implements AiResourceMapper {
