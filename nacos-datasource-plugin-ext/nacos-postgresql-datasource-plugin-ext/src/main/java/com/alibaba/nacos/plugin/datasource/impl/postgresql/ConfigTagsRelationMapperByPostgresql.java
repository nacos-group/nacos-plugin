...
public class ConfigTagsRelationMapperByPostgresql extends AbstractMapperByPostgresql
    ...
    public MapperResult findConfigInfo4PageFetchRows(MapperContext context) {
        ...
        where.append(" a.tenant_id=COALESCE(?, '").append(DEFAULT_NAMESPACE_ID).append("') ");
    ...
    public MapperResult findConfigInfoLike4PageFetchRows(MapperContext context) {
        ...
        List<Object> paramList = new ArrayList<>();
        StringBuilder where = new StringBuilder(" WHERE ");
        final String sqlFetchRows = "SELECT a.id,a.data_id,a.group_id,a.tenant_id,a.app_name,a.content,a.md5,a.type "
