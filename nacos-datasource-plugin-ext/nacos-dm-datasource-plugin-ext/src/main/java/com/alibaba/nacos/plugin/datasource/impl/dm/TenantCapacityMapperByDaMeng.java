...
/**
 * The dameng implementation of TenantCapacityMapper.
 *
 * @author Xiao Yong
 **/
public class TenantCapacityMapperByDaMeng extends AbstractMapperByDaMeng implements TenantCapacityMapper {
    ...
    public MapperResult getCapacityList4CorrectUsage(MapperContext context) {
        String sql = getLimitTopSqlWithMark("SELECT id, tenant_id FROM tenant_capacity WHERE id>?");
