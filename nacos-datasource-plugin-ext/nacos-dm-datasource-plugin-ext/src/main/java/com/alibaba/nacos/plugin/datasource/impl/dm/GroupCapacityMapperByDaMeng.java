 ...
 * @author Xiao Yong
 **/
public class GroupCapacityMapperByDaMeng extends AbstractMapperByDaMeng implements GroupCapacityMapper {
    ...
    public MapperResult selectGroupInfoBySize(MapperContext context) {
        String sql = getLimitTopSqlWithMark("SELECT id, group_id FROM group_capacity WHERE id > ?");
