 ...
 * @author Ken
 */
public class AiResourceVersionMapperByYasdb extends AbstractYasdbMapper implements AiResourceVersionMapper {
    ...
    public MapperResult findAiResourceVersionFetchRows(MapperContext context) {
        ...
        String sql = getDatabaseDialect().getLimitPageSqlWithOffset(built.getSql() + " ORDER BY gmt_modified DESC ",
