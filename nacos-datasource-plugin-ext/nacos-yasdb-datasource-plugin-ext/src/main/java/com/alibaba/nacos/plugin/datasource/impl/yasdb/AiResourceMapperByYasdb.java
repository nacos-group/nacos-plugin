 ...
 * @author Ken
 */
public class AiResourceMapperByYasdb extends AbstractYasdbMapper implements AiResourceMapper {
    ...
    public MapperResult findAiResourceFetchRows(MapperContext context) {
        ...
        String sql = getDatabaseDialect().getLimitPageSqlWithMark(built.getSql() + resolveOrderByClause(context));
