...
CREATE TABLE "HIS_CONFIG_INFO" (
    ...
    group_id VARCHAR2(128) NULL,
    app_name VARCHAR2(128) DEFAULT NULL,
    content CLOB NULL,
    md5 VARCHAR2(32) DEFAULT NULL,
    gmt_create TIMESTAMP DEFAULT SYSTIMESTAMP NULL,
    gmt_modified TIMESTAMP DEFAULT SYSTIMESTAMP NULL,
    src_user CLOB DEFAULT NULL,
    src_ip VARCHAR2(50) DEFAULT NULL,
    op_type VARCHAR2(10) DEFAULT NULL,
    tenant_id VARCHAR2(128) DEFAULT NULL,
    encrypted_data_key VARCHAR2(1024) DEFAULT NULL,
    publish_type VARCHAR2(50) DEFAULT NULL,
    gray_name VARCHAR2(128) DEFAULT NULL,
    ext_info CLOB DEFAULT NULL,
    CONSTRAINT his_config_info_pk PRIMARY KEY (nid)
...
-- config_info_gray
CREATE TABLE "NACOS_V311"."CONFIG_INFO_GRAY" (
...
-- 为 config_info_gray 表添加唯一约束
ALTER TABLE "CONFIG_INFO_GRAY" ADD CONSTRAINT UK_CONFIGINFOGRAY_DATAGROUPTENANTGRAY UNIQUE ("DATA_ID", "GROUP_ID", "TENANT_ID", "GRAY_NAME");

-- 为 config_info_gray 表创建索引
